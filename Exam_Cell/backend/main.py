...
try:
    from auth import login, verify_token, verify_admin_token, verify_invigilator_token, revoke_token, clear_all_tokens
...
async def serve_admin_login():
    ...
    login_path = FRONTEND_DIR / "admin_login.html"
...
async def serve_invigilator_login():
    ...
    login_path = FRONTEND_DIR / "invig_login.html"
    if not login_path.exists():
...
async def serve_invigilator():
    ...
    invig_path = FRONTEND_DIR / "invigilator.html"
...
async def serve_lookup():
    ...
    lookup_path = FRONTEND_DIR / "lookup.html"
